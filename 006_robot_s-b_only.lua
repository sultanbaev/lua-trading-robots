...
STOP_LOSS         = 40;                   -- Ðàçìåð ÑÒÎÏ-ËÎÑÑÀ (â øàãàõ öåíû)
TAKE_PROFIT       = 10;                   -- Ðàçìåð ÒÅÉÊ-ÏÐÎÔÈÒÀ (â øàãàõ öåíû)
...
CurrentDirect     = 'SELL';                -- Òåêóùåå ÍÀÏÐÀÂËÅÍÈÅ ['BUY', èëè 'SELL']
