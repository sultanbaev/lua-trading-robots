...
ACCOUNT           = 'SPBFUTJR9PN';        -- Идентификатор счета
CLASS_CODE        = 'SPBFUT';             -- Код класса
SEC_CODE          = 'RIH6';               -- Код бумаги
...
STOP_LOSS         = 50;                   -- Размер СТОП-ЛОССА (в шагах цены)
TAKE_PROFIT       = 100;                   -- Размер ТЕЙК-ПРОФИТА (в шагах цены)
