...
MIN_P_SPREAD = 0.01    -- минимальный пороговый процент спреда
MIN_SPREAD_STEP = 15     -- минимальное количество шагов спреда, когда открываем позицию
SEC = "RIH9"
CLASS = "SPBFUT"
PRICE_STEP = 1  -- шаг цены по инструменту
PRICE_SCALE = 1   -- точность задания цены инструмента

TRADE_ACC   = "SPBFUTJR9PN"   -- торговый счет
CLIENT_CODE = "SPBFUTJR9PN"          -- код клиента
